...
/*  end here*/
 ...
 /** Get the level of the node */
  ...
  addNode(node: TreeNode,type,name) {
    type=node.type
  ...
  // saveNode(node: TreeNode, itemValue: string, type: any) {
  //  if (type.value ==RatingConstants.TYPE_ZONE)
  //   {
  //   const parentIcon =this.getLevel(node);
  //   if(parentIcon==3)//it check first at level 3
  //   {
  //     if(type.value==RatingConstants.TYPE_ZONE)//this if check is there universal exist or not
  //     {
  //     const message = `Universal Already Exist!...`;
  //     const dialogData = new ConfirmDialogModel("Failed to Add", message);
  //     const dialogRef = this.dialog.open(PopupComponent, {
  //     data: dialogData
  //     });
  //     }
  //     else //if Universal not it should be add
  //     {
  //     const nestedNode = this.flatNodeMap.get(node);
  //     this._database.updateItem(nestedNode!, itemValue, type.value);
  //     }
  //   }
  //   else if(parentIcon==5)//it check first at level 3
  //   {
  //     const message = `Global Already Exist!...`;
  //     const dialogData = new ConfirmDialogModel("Failed to Add", message);
  //     const dialogRef = this.dialog.open(PopupComponent, {
  //     data: dialogData
  //   });
  //   }
  //   else if(type.value==RatingConstants.TYPE_ZONE)//if the node are not from level 3 and 5 five then
  //   {
  //     const nestedNode = this.flatNodeMap.get(node);
  //     this._database.updateItem(nestedNode!, itemValue, type.value);
  //   }
  //   else//this condition is for check for every node if there is zone_node exist or not
  //   {
  //     const message = `Zone Already Exist!...`;
  //     const dialogData = new ConfirmDialogModel("Failed to Add", message);
  //     const dialogRef = this.dialog.open(PopupComponent, {
  //     data: dialogData
  //    });
  //   }
  //  }
  // else//if zone not exist then it will ome at this else block
  //   {
  //   const nestedNode = this.flatNodeMap.get(node);
  //   this._database.updateItem(nestedNode!, itemValue, type.value);
  //   console.log("from else 3",nestedNode);
  //   }
  // }
